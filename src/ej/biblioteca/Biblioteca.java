...
public class Biblioteca {
	...
	/*
	 * Realiza el prestamos pasado un libro de la lista de libros disponibles a la
	 * lista de libros prestados Devuelve: 0 si no existe el libro en niguna de la
	 * listas 1 Si puede prestarlo, el libro pasa de ldisponibles a lprestados -1 Si
	 * ya esta prestado.
	 */
